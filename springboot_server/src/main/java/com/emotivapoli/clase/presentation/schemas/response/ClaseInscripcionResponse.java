...
public class ClaseInscripcionResponse {
    private Long id;
    private UUID uid;
    ...
    public LocalDateTime getClaseFechaHoraInicio() { return claseFechaHoraInicio; }
    public void setClaseFechaHoraInicio(LocalDateTime claseFechaHoraInicio) { this.claseFechaHoraInicio = claseFechaHoraInicio; }
